    ...
    public static class IdentifierMapCodegen
    {
        ...
        public static void Generate()
        {
            ...
            foreach (var group in groups)
            {
                ...
                {
                    int stableId = asset.name.GenerateIndex(); 
                    
                    sb.AppendLine($"        public const int {asset.name} = {stableId};");
                }
            ...
            Debug.Log($"Identifier maps generated for {groups.Count()} containers.");
        }
    }
}
#endif